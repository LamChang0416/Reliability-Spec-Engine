...
const ASSETS = [
  ...
  './api/validator.js',
  './data/databases/mil810_database.json',
  './data/databases/gr63_database.json',
  './data/databases/astm4169_database.json',
  './data/databases/iec_database.json',
  './data/databases/sr332_database.json',
  './data/databases/ista_database.json',
  './data/databases/iec60068_database.json',
  './data/databases/ip_code_database.json',
